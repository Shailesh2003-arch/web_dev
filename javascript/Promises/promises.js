...
xhr.onreadystatechange = function(){  // continuosly tracks the http request...
    ...
    if(xhr.readyState===4){
        ...
        resolve(); // resolve method resolves the promise and states that the promise is fullfilled...
        
}
}
});

myPromise.then(function(){ // .then() takes a callback function which is directly related to the resolve()...
